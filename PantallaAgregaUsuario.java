...
public class PantallaAgregaUsuario extends JFrame implements ActionListener {
	...
	private JButton botonAgregaUsuario;

	public PantallaAgregaUsuario() {
		...
		botonAgregaUsuario = new JButton("Crear Usuario");
		botonAgregaUsuario.setForeground(Color.RED);
		botonAgregaUsuario.setBackground(Color.WHITE);
		botonAgregaUsuario.setBounds(100,345,120,30);
		botonAgregaUsuario.addActionListener(this);
		add(botonAgregaUsuario);
...
*/
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == botonAgregaUsuario) {
	...
	public static void main(String[] args) {
		...
		PantallaAgregaUsuario objPantallaAgregaUsuario = new PantallaAgregaUsuario();
		objPantallaAgregaUsuario.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		objPantallaAgregaUsuario.setBounds(0,0,340,450);
		objPantallaAgregaUsuario.setResizable(true);
		objPantallaAgregaUsuario.setLocationRelativeTo(null);
		objPantallaAgregaUsuario.setVisible(true);
